...
# Manually setting the path to the ChromeDriver
...
# Finding all the PDF links in the judgments column
...
# Iterating through the list of URLs and download the PDFs
for url in urls:
